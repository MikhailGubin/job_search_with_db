...
def user_interaction() -> None:
    ...
    answer_2 = input("Вывести на экран список всех вакансий с указанием названия компании, названия\n"
                     "вакансии, зарплаты и ссылки на вакансию? Да/Нет ")
    answer_3 = input("Вывести на экран среднюю зарплату по всем вакансиям? Да/Нет ")
    answer_4 = input("Вывести на экран список всех вакансий, у которых зарплата выше средней зарплаты\n"
                     "по всем вакансиям? Да/Нет ")
    answer_5 = input("Вывести на экран список всех вакансий, в названии которых содержатся переданные\n"
