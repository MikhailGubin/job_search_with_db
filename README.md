...
## Описание:      
    Данная программа получает данные о компаниях и вакансиях с платформы hh.ru, сохраняет их в таблицы в БД PostgreSQL. 
...
*   Backend:
    ...
    *   База данных: PostgreSQL (с использованием psycopg2 2.9.10)      

*  Тестирование:   
    *   Фреймворк тестирования: Pytest 8.3.4
    *   Анализ покрытия кода: Pytest-cov 6.0.0
...
*   Инструменты линтинга и форматирования:
    ...
    *   Линтер: Flake8 7.3.0 
    *   Статическая проверка типов: Mypy 1.15.0

## Установка:
1. #### Клонируйте репозиторий:
```commandline
python
git clone git@github.com:MikhailGubin/job-search-with-db.git
```
